...
message(STATUS "intro_tutorial: 1 messages, 0 services")

set(MSG_I_FLAGS "-Iintro_tutorial:/root/ir-ros-docker/ir/course_ws/src/intro_tutorial/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/root/ir-ros-docker/ir/course_ws/src/intro_tutorial/msg/msg1.msg" NAME_WE)
add_custom_target(_intro_tutorial_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "intro_tutorial" "/root/ir-ros-docker/ir/course_ws/src/intro_tutorial/msg/msg1.msg" ""
)
...
_generate_msg_cpp(intro_tutorial
  "/root/ir-ros-docker/ir/course_ws/src/intro_tutorial/msg/msg1.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/intro_tutorial)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/intro_tutorial\")")
  # install generated code
  install(
